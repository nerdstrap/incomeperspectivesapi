...
module.exports.baseline = function (currentAge, retirementAge, numberOfPeriods, annualDeposit, growthRate, rateOfReturn, managementFee, initialWithdrawal, inflationRate) {
...
module.exports.breakEvenAnalysis = function (currentAge, retirementAge, numberOfPeriods, annualDeposit, growthRate, rateOfReturn, managementFee, insuranceProductIncome, initialWithdrawal, inflationRate) {
	var yearsUntilRetirement = retirementAge - currentAge;
	var yearsCompounded = yearsUntilRetirement;
